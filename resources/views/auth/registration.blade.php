                ...
                <div class="card-body bg-light">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required autofocus aria-label="Name">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required aria-label="Email">
                            @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" required aria-label="Password">
                        ...
                        <div class="text-center">
                            <a href="{{ route('login') }}" class="text-decoration-none text-danger fw-bold">Already have an account?</a>
                        </div>
                    </form>
                </div>
            </div>

    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('discussions.index') }}">Discussion</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link btn-theme hover:btn-theme" href="{{ route('register') }}">{{ __('Register') }}</a>
                </li>
                @endif
                @else
                @if (Auth::user()->role == 'admin') <!-- Corrected equality check -->
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ route('solutions.index') }}">Solutions</a></li>
                    </ul>
                </li>
                @endif
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link " href="#" role="button" aria-haspopup="true" aria-expanded="false" v-pre>
                        <img src="{{ asset('images/avator.png') }}" alt="User Avatar" class="rounded-circle" style="width: 30px; height: 30px;"/> {{ Auth::user()->name }}
                    </a>

...
<div class="flex flex-col h-screen">
    ...
    <nav class="bg-gray-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center">
                <span class="text-xl font-bold"> <a href="<?php echo e(url('/')); ?>">  CodeIt Academy </a></span>
            </div>
            <div class="flex items-center">
                ...
                <form method="POST" action="<?php echo e(url('user/two-factor-authentication')); ?>" class="mr-4 ml-4">
                    <?php echo csrf_field(); ?>
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" class="flex items-center">
                        <img src="<?php echo e(asset('images/user.png')); ?>" alt="User Avatar" class="h-8 w-8 rounded-full">
    ...
    <div class="flex-grow flex">
        ...
        <aside class="bg-gray-800 w-64 p-4 hidden md:block">
            <div class="mb-8">
                <img src="<?php echo e(asset('images/user.png')); ?>" alt="User Avatar" class="h-20 w-20 rounded-full mx-auto mb-2">
                <h2 class="text-center font-bold"><?php echo e(Auth::user()->name); ?></h2>
            </div>
            <nav>
                <h3 class="text-gray-500 font-bold mb-2">LEARN</h3>
                <a href="<?php echo e(route('home')); ?>" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                    Dashboard
                </a>
                <a href="<?php echo e(route('challenges')); ?>" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="<?php echo e(route('completed-challenges.index')); ?>" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    Completed Challenges
                </a>
                <a href=" <?php echo e(route('certificates')); ?>" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    My Certificates
                ...
                <a href=" <?php echo e(route('solutions.index')); ?>" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    Solutions
                </a>
                <a href=" <?php echo e(route('users.index')); ?>" class="flex items-center py-2 px-4 rounded hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    Users
...
<?php /**PATH C:\xampp\htdocs\DevCom\resources\views/layouts/master.blade.php ENDPATH**/ ?>
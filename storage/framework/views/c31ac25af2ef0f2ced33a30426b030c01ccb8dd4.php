                    ...
                    <div class="card-body bg-light text-center d-flex flex-column">
                        ...
                        <div class="d-grid mt-auto"> <!-- mt-auto pushes this div to the bottom -->
                            ...
                            <form id="processPaymentForm" action="<?php echo e(route('purchase')); ?>" method="POST">
                                ...
                                <input type="hidden" name="amount" value="<?php echo e($plan->amount); ?>"> <!-- Amount: The payment amount -->
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DevCom\resources\views/index.blade.php ENDPATH**/ ?>